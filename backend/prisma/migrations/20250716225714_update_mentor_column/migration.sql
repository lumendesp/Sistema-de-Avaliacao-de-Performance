/*
  ...
  - A unique constraint covering the columns `[evaluationId,criterionId]` on the table `ManagerEvaluationItem` will be added. If there are existing duplicate values, this will fail.
...
-- CreateIndex
CREATE UNIQUE INDEX "ManagerEvaluationItem_evaluationId_criterionId_key" ON "ManagerEvaluationItem"("evaluationId", "criterionId");
