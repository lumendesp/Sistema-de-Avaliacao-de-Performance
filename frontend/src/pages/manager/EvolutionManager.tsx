...
const EvolutionManager = () => {
  ...
  if (!userId) return <div className="p-6 text-gray-500">Usuário não autenticado.</div>;
  
  if (loading) return <div className="p-6 text-gray-500">Carregando histórico...</div>;
