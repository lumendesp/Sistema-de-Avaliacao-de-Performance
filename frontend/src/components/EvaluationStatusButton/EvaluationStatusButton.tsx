...
function EvaluationStatusButton({
  ...
  return (
    <button
      className={`w-full flex items-center justify-between p-4 rounded-lg transition-colors duration-200 shadow-sm ${bg} ${text} ${className}`}
      {...props}
    >
      <div className="flex items-start gap-3 text-left">
        ...
        >
          ...
          <path d="M15.3333 34.5H17.25" stroke="currentColor" strokeWidth="3.83333" strokeLinecap="round" strokeLinejoin="round"/>
        </svg>
        <div>
