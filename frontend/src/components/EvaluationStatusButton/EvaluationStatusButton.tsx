...
} from '../../types/evaluationStatusButton';
...
function EvaluationStatusButton({
  ...
  const baseClasses =
    'w-full flex items-center justify-between p-4 rounded-lg transition-colors duration-200 shadow-sm';
  const combinedClasses = `${baseClasses} ${config.bg} ${config.text} ${className}`;
