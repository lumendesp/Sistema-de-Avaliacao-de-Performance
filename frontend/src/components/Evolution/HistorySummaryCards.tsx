...
const HistorySummaryCards: React.FC<HistorySummaryCardsProps> = ({
  currentScore,
  growth,
  totalEvaluations,
}) => (
  <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 mb-8 w-full max-w-full overflow-x-hidden">
    <div className="bg-white rounded-lg shadow p-4 flex flex-col items-center w-full">
      ...
      <span className="text-xs text-gray-400">
        Nota final do ciclo mais recente
      </span>
    </div>
    <div className="bg-white rounded-lg shadow p-4 flex flex-col items-center w-full">
