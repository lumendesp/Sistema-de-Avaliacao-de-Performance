...
const RHCircularProgressCard: React.FC<RHCircularProgressCardProps> = ({ percentage, description }) => {
    const sqSize = 100;
    ...
    return (
        <div className="bg-white rounded-xl shadow-md p-6 flex items-center justify-between">
            <div>
                <h2 className="text-lg font-semibold text-gray-700">Preenchimento de avaliação</h2>
            ...
            <div className="relative" style={{ width: sqSize, height: sqSize }}>
                <svg width={sqSize} height={sqSize} viewBox={viewBox}>
                    ...
                    <circle className="stroke-current text-green-500" strokeLinecap="round" strokeWidth={`${strokeWidth}px`} fill="none"
